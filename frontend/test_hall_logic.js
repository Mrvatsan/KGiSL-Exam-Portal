...
const getBlockFromHallNo = (hallNo) => {
...
const getFloorFromHallNo = (hallNo, block) => {
    const hallNum = parseInt(hallNo);
    if (isNaN(hallNum)) return 'Unknown';
...
const testCases = [
    ...
    // Innovation Block tests - NEW CASES
    { hallNo: '1002', expectedBlock: 'Innovation Block (IT Tower)', expectedFloor: 'First Floor' },
    { hallNo: '2001', expectedBlock: 'Innovation Block (IT Tower)', expectedFloor: 'Second Floor' },
    ...
    { hallNo: '5003', expectedBlock: 'Innovation Block (IT Tower)', expectedFloor: 'Fifth Floor' },
    ...
    { hallNo: '1999', expectedBlock: 'Innovation Block (IT Tower)', expectedFloor: 'First Floor' },
    { hallNo: '2999', expectedBlock: 'Innovation Block (IT Tower)', expectedFloor: 'Second Floor' },
    { hallNo: '3999', expectedBlock: 'Innovation Block (IT Tower)', expectedFloor: 'Third Floor' },
    { hallNo: '5999', expectedBlock: 'Innovation Block (IT Tower)', expectedFloor: 'Fifth Floor' },
];
